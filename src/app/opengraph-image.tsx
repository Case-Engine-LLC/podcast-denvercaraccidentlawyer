  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {HOST_TITLE} · Colorado-specific car accident, motorcycle, dog-bite, and wrongful death cases from a Denver trial attorney who used to defend insurance companies.
        </div>
        ...
        >
          {showStatsRow ? (
            <div style={{ display: 'flex', gap: 28, alignItems: 'center' }}>
              ...
              <span style={{ display: 'flex' }}>Denver, Colorado</span>
            </div>
          ) : (
            <div style={{ display: 'flex', gap: 28, alignItems: 'center' }}>
              <span style={{ display: 'flex' }}>Denver, Colorado</span>
